"""
Файл с константами, нужными для работы алгоритма
"""


#Размер одного блока шифра в байтах
BLOCK_SIZE = 16

#Размер входящего ключа шифра в байтах
KEY_SIZE = 32



#Табличка для вычесления значений поля Галуа
GF = [[
...
#Таблица линейного преобразования, используемая в s_box
S_BOX = [
...
#Таблица обратная таблице s_box, для того чтобы мы могли расшифровать то что набедокурили
S_BOX_REVERSE = [
